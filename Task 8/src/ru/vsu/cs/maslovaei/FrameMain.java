...
public class FrameMain extends JFrame {
    ...
    public FrameMain() {
        ...
        menuLookAndFeel.setText("Number 31");
        ...
        buttonTransform.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    int[][] matrix = JTableUtils.readIntMatrixFromJTable(tableInput);
                    ArrayWithoutMinAndMaxElements.createdNewArray(matrix);
                    JTableUtils.writeArrayToJTable(tableOutput, ArrayWithoutMinAndMaxElements.createdNewArray(matrix));
                } catch (Exception e) {
                    SwingUtils.showErrorMessageBox(e);
                }
            }
